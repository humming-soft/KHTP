 <div id="dashboard" class="col-md-12 project_green">
	...
	<div class="row">
		...
		<div class="custom_breadcrumb col-md-12">
			<div class="">
				<nav class="">
					...
					<a class="custom_breadcrumb-item" href="current_year_performance_range_1616.php">Performance For Year Ending 2016</a>
					<span><i class="fa fa-angle-right breadcrumb_divider" aria-hidden="true"></i></span>
					<span class="custom_breadcrumb-item active">GREEN</span>
				</nav>
			</div>
			<div class="title">
				GREEN
		...
		<script type="text/javascript" src="../assets/js/demo_current_project_green.js"></script>
