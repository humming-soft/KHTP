		...
		<div class="custom_breadcrumb col-md-12">
			<div class="">
				<nav class="">
					...
					<span><i class="fa fa-angle-right breadcrumb_divider" aria-hidden="true"></i></span>
					<a class="custom_breadcrumb-item" href="current_project_canteenrenovation.php">Canteen Renovation</a>
					<span><i class="fa fa-angle-right breadcrumb_divider" aria-hidden="true"></i></span>
					<span class="custom_breadcrumb-item active">Canteen Post Contract</span>
				</nav>
			</div>
			<div class="title">
				Canteen Post Contract
			</div>
		</div>
		
		<div class="col-md-12 plate_portlet">
		<script type="text/javascript" src="../assets/js/milestone_canteenrenovation_a1.js"></script>
			<div class="row">
