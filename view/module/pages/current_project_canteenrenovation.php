 <div id="dashboard" class="col-md-12">
	...
	<div class="row">
		...
		<div class="custom_breadcrumb col-md-12">
			<div class="">
				<nav class="">
					...
					<span><i class="fa fa-angle-right breadcrumb_divider" aria-hidden="true"></i></span>
					<span class="custom_breadcrumb-item active">Canteen Renovation</span>
				</nav>
			</div>
			<div class="title">
				Canteen Renovation
		...
		<script type="text/javascript" src="../assets/js/demo_current_project_canteenrenovation.js"></script>
